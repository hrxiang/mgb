...
public class GestureLockThumbnailView extends View {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,
                com.wangnan.library.R.styleable.GestureLockThumbnailView);
        mNormalColor = array.getColor(
                com.wangnan.library.R.styleable.GestureLockThumbnailView_thumbnail_color,
                Painter.NORMAL_COLOR);
        mRadiusRatio = array.getFloat(
                com.wangnan.library.R.styleable.GestureLockThumbnailView_thumbnail_ratio, 0.6F);
        array.recycle();
    }
    ...
    public void clearView(long millisecond) {
        postDelayed(() -> {
            restorePointStatus();
            invalidate();
        }, millisecond);
