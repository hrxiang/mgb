...
/**
 * Created by xianghairui on 2018/9/20
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFFB1B5C9;//FF666666
    private int tabSelectedTextColor = 0xFF28336D;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorHeight = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight,
                indicatorHeight);
        indicatorWidth = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorWidth,
                indicatorWidth);
        ...
        tabSelectedTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextColor,
                tabSelectedTextColor);
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsUnselectedTabTextColor,
                tabTextColor);
        tabSelectedTextSize = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextSize, tabSelectedTextSize);
        tabTextSize = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pstsUnselectedTabTextSize, tabTextSize);
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (indicatorWidth > 0) {
            float center = lineLeft + (lineRight - lineLeft) / 2f;
            lineLeft = center - indicatorWidth / 2;
            lineRight = center + indicatorWidth / 2;
        }
    ...
    private class PageListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            scrollToChild(position, (int) (positionOffset * tabsContainer.getChildAt(
                    position).getWidth()));
