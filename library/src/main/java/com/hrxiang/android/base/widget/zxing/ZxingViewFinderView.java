package com.hrxiang.android.base.widget.zxing;
...
/**
 * Created by xianghairui on 2018/5/18.
 */
...
public class ZxingViewFinderView extends ViewfinderView {
    ...
    private final static int LASER_MOVE_DISTANCE_PER_UNIT_TIME = 25;
    ...
    public ZxingViewFinderView(Context context, @Nullable AttributeSet attrs) {
        ...
        scannerBoundColor = attributes.getColor(R.styleable.ZxingViewFinderView_scannerBoundColor, Color.parseColor("#FFFFFF"));
        scannerBoundWidth = attributes.getDimension(R.styleable.ZxingViewFinderView_scannerBoundWidth, 0.5f);
        scannerBoundCornerColor = attributes.getColor(R.styleable.ZxingViewFinderView_scannerBoundCornerColor, Color.parseColor("#FFF7D23E"));
        ...
        scannerTipTextColor = attributes.getColor(R.styleable.ZxingViewFinderView_scannerTipTextColor, Color.parseColor("#FFFFFF"));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            postInvalidateDelayed(ViewfinderView.ANIMATION_DELAY, frame.left - ViewfinderView.POINT_SIZE, frame.top - ViewfinderView.POINT_SIZE, frame.right + ViewfinderView.POINT_SIZE, frame.bottom + ViewfinderView.POINT_SIZE);
        }
    }
    ...
    private void drawLaserLine(Canvas canvas, Rect frame) {
        if (scannerLaserResId == 0) {
            ...
            paint.setAlpha(ViewfinderView.SCANNER_ALPHA[scannerAlpha]);
            scannerAlpha = (scannerAlpha + 1) % ViewfinderView.SCANNER_ALPHA.length;
    ...
    private void drawResultPoint(Canvas canvas, Rect frame, Rect previewFrame) {
        ...
        if (currentPossible.isEmpty()) {
            ...
            for (ResultPoint point : currentPossible) {
                canvas.drawCircle(frameLeft + (int) (point.getX() * scaleX), frameTop + (int) (point.getY() * scaleY), ViewfinderView.POINT_SIZE, paint);
            }
        }
        if (currentLast != null) {
